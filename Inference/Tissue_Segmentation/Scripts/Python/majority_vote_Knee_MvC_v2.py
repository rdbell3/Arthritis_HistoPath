...
def majority_vote(path, n_classes, size, im_size):
    ...
    for slides in tqdm(folders):
        ...
        images = os.listdir(f'{root_path}\\{og_fold}\\{slides}')
...
#%%
path = 'C:\\Users\\bellr\\Documents\\Richard Data\\TNF-Tg_12mo\\QP_TNF-Tg_12Mo\\'
...
if __name__ == '__main__':
    ...
    run_complex_operations(majority_vote(path, 10, 2048, 512), range(10), processes_pool)
...
# path = 'C:\\Users\\bellr\\Documents\\Richard Data\\TNF-Tg_12mo\\QP_TNF-Tg_12Mo\\'
# run_complex_operations(majority_vote(path, 10, 2048, 512), input, pool)
